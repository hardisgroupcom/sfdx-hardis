...
description: With sfdx-hardis, send notifications on Teams channels during CI/CD operations
---
...
If you prefer email-based notifications, you can also use [Email Notifications](https://sfdx-hardis.cloudity.com/salesforce-devops-setup-integration-email/) with the Teams channel email address as `NOTIF_EMAIL_ADDRESS`.
