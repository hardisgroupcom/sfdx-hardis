...
description: With sfdx-hardis, learn how to initialize the SFDX sources of a CI/CD project from an existing Salesforce org, and how to clean the retrieved metadata
---
...
See [Install packages](salesforce-devops-work-on-user-story-install-packages.md).
