...
| Bitbucket    | `CI_SFDX_HARDIS_BITBUCKET_TOKEN` | [Bitbucket integration](salesforce-devops-setup-integration-bitbucket.md#using-bitbucket-integration-from-jenkins) |
