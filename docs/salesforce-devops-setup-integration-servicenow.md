...
description: With sfdx-hardis, enrich pull requests with ServiceNow record info and post work notes on tickets when they are deployed to a Salesforce org
---
