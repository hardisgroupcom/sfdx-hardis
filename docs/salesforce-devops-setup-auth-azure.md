...
description: With sfdx-hardis, learn how to configure CI/CD variables for CI Server authentication to automate deployments with Azure Pipelines
---
<!-- markdownlint-disable MD013 -->

## Pre-requisites

If you are building a CI/CD pipeline, follow the steps in [Configure Integrations between sfdx-hardis and Azure Pipelines](salesforce-devops-setup-integration-azure.md) to create your pipelines.
