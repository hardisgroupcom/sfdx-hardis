...
The VS Code extension can discover custom menus exposed by installed non-core Salesforce CLI plugins.
...
Clickable buttons then appear at the bottom of the command execution UI.
