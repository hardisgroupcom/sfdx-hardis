...
description: With sfdx-hardis, learn how to activate Dev Hub and sandbox source tracking, apply the org settings, and create the major org sandboxes for a Salesforce CI/CD project
---
...
You can now go to step [3. Initialize the SFDX project](salesforce-devops-setup-init-project.md).
