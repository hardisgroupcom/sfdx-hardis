...
To define your own variable content, you can define a local file **config/prompt-templates/VARIABLE_FORMATTING_REQUIREMENTS.md**

> For backward compatibility, **config/prompt-templates/VARIABLE_FORMATTING_REQUIREMENTS.txt** is also supported, but **.md is preferred**.
