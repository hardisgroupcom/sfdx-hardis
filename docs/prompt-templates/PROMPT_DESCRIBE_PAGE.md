...
To define your own prompt text, you can define a local file **config/prompt-templates/PROMPT_DESCRIBE_PAGE.md**

> For backward compatibility, **config/prompt-templates/PROMPT_DESCRIBE_PAGE.txt** is also supported, but **.md is preferred**.
