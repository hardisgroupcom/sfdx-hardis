...
description: With sfdx-hardis, learn how to create the repository, create and protect the major branches, and define the merge rules
---
...
See [Hotfixes](salesforce-devops-hotfixes.md) for the process, and [Retrofit](salesforce-devops-retrofit.md) for the step that brings the fix back down into the BUILD branches.
...
You can now go to step [2. Prepare the Salesforce orgs](salesforce-devops-setup-activate-org.md).
