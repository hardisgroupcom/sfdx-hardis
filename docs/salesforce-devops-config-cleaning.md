...
description: With sfdx-hardis, learn how to configure the automated cleaning of sfdx sources before creating a Merge Request
---
...
sfdx-hardis provides a set of commands to automate those boring XML updates that can be called every time a user [prepares a Pull Request](salesforce-devops-publish-user-story.md#prepare-merge-request) (Merge Request on GitLab) using command [sf hardis:work:save](https://sfdx-hardis.cloudity.com/hardis/work/save/)
