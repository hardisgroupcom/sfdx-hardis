...
- [On GitHub](salesforce-devops-pull-request-github.md)
- [On GitLab](salesforce-devops-merge-request-gitlab.md)
- [On Azure DevOps](salesforce-devops-pull-request-azure.md)
- [On Bitbucket](salesforce-devops-pull-request-bitbucket.md)
