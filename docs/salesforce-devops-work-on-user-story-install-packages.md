...
description: With sfdx-hardis, learn how to install a managed or unlocked package in your dev org and how to make the CI/CD pipeline install it in the other orgs
---
