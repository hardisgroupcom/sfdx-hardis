...
| From a [promotion branch (experimental)](salesforce-devops-promotion-branches.md) (ex: `promotion/uat/preprod/2026-09-06-1430` to `preprod`), when `enablePromotionBranches` is set | The Pull Requests declared in the promotion Pull Request description |
