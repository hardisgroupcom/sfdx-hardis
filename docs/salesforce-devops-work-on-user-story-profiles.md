...
description: With sfdx-hardis, learn how to handle Profiles and Permission Sets on a Salesforce CI/CD project, and which Profile settings cannot be deployed
---
