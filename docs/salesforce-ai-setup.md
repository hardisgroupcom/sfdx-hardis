...
| LANGCHAIN_LLM_TEMPERATURE    | Controls randomness (0-1)                                                                 | 0.7           |
| LANGCHAIN_LLM_MAX_TOKENS     | Maximum number of tokens to generate                                                      |               |
| LANGCHAIN_LLM_MAX_RETRIES    | Number of retries for failed requests                                                     | 3             |
| LANGCHAIN_LLM_BASE_URL       | Base URL for the API (mainly for Ollama)                                                  | http://localhost:11434 |
