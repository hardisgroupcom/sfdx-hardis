...
|flows|option|Comma-separated list of Flow API names, to restrict Flow cleanings to those Flows||||
|json|boolean|Format output as json.||||
|skipauth|boolean|Skip authentication check when a default username is required||||
|type<br/>-t|option|Cleaning type|||all<br/>caseentitlement<br/>checkPermissions<br/>dashboards<br/>datadotcom<br/>destructivechanges<br/>entitlement<br/>flowPositions<br/>listViewsMine<br/>localfields<br/>minimizeProfiles<br/>productrequest<br/>sensitiveMetadatas<br/>systemDebug<br/>v60|
