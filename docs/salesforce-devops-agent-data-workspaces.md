...
- [Deployment actions](salesforce-devops-work-on-user-story-deployment-actions.md): all deployment action types
- [Using sfdx-hardis with AI Coding Agents](salesforce-devops-agent-skills.md): other agent skills
