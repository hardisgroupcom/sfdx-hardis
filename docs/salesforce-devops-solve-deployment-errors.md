...
description: With sfdx-hardis, learn how to read the deployment job log and solve the deployment, Apex test and code coverage errors reported on your Pull Request
---
