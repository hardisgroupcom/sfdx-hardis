...
- **If you are trained with git**, you can [solve the conflicts](salesforce-devops-validate-merge-request.md#conflicts) by merging the target branch into your own branch.
- Otherwise, ask your [release manager](salesforce-devops-release-home.md).
...
If you see errors, read [Solve deployment errors](salesforce-devops-solve-deployment-errors.md).
...
If you see errors, read [Solve MegaLinter errors](salesforce-devops-solve-megalinter-errors.md).
