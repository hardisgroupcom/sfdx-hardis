...
description: With sfdx-hardis, learn how to use package-no-overwrite.xml to protect metadata that is maintained directly in a Salesforce org from being overwritten by CI/CD deployments
---
