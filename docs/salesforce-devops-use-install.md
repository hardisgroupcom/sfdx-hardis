...
Your computer is ready. Next: [create a Git access token](salesforce-devops-git-tokens.md), then [clone the repository](salesforce-devops-clone-repository.md) of your project.
