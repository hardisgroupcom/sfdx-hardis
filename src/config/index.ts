...
const PR_COMMENT_BANNERS: Record<PrCommentBannerKey, { file: string; altTextKey: string }> = {
  ...
  'validation-pending': { file: 'pr-banner-validation-pending.png', altTextKey: 'prBannerValidationPending' },
  ...
  'deployment-pending': { file: 'pr-banner-deployment-pending.png', altTextKey: 'prBannerDeploymentPending' },
...
export const getPrCommentBannerMarkdown = (bannerKey: PrCommentBannerKey | null | undefined): string => {
  ...
  return `![${t(banner.altTextKey)}](${CONSTANTS.PR_COMMENT_BANNER_BASE_URL}${banner.file})\n\n`;
}
