...
With \`enablePromotionBranches: true\`, a merge from a [promotion branch](${CONSTANTS.DOC_URL_ROOT}/salesforce-ci-cd-promotion-branches/) (named \`promotion/<source>/<target>/<YYYY-MM-DD>-<counter>\`, ex: \`promotion/uat/preprod/2026-09-06-1\`, assembled by cherry-picking approved User Stories) keeps the deployment actions, Apex test classes and custom behaviors (NO_DELTA, PURGE_FLOW_VERSIONS...) of the Pull Requests declared in its description with \`promotionPullRequests: [482, 487]\`.
