...
`;
  ...
  public static examples = [
    ...
    '$ GITHUB_TOKEN=xxxx GITHUB_REPOSITORY=myuser/myrepo FORCE_TARGET_BRANCH=uat NODE_OPTIONS=--inspect-brk sf hardis:project:deploy:smart --check --websocket localhost:2702 --skipauth --target-org my-salesforce-org@client.com'
  ];
