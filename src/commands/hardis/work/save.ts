...
- Push commit to server
  ...
  - Use New task menu (sfdx hardis:work:new), even if you work in the same sandbox or scratch org :)`,
    ...
    uxLog(this, c.cyan(`Merge request documentation is available here -> ${c.bold('https://sfdx-hardis.cloudity.com/salesforce-ci-cd-publish-task/#create-merge-request')}`));
