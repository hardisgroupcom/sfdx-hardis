...
`
  ...
  "PROMPT_DESCRIBE_AUTORESPONSE_RULES": {
    ...
    text: {
      "en": `You are a skilled business analyst working on a Salesforce project. Your goal is to summarize the content and behavior of the Salesforce Assignment Rules "{{AUTORESPONSERULES_NAME}}" in plain English, providing a detailed explanation suitable for a business user.
...
- The metadata XML for Salesforce Assignment Rule "{{AUTORESPONSERULES_NAME}}" is:
